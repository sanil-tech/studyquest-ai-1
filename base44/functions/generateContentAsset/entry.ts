    ...
    properties: {
      ...
      concrete: {
        ...
        properties: {
          ...
          visual_prompt: { type: "string", description: "Prompt visual 3D Pixar terperinci yang menggambarkan objek dan bilangan sebenar yang disebut dalam penerangan" },
        },
      ...
      pictorial: {
        ...
        properties: {
          ...
          visual_prompt: { type: "string", description: "Prompt visual 3D Pixar atau rajah visual bagi fasa bergambar" },
        },
        required: ["title", "explanation"],
      },
      abstract: {
